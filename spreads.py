...
# 他/她/我们 是推断层主体词；感情类词**直接引用 KEYWORD_MAP 感情组**，不再抄一份
# 字面量。抄过的那份曾漏「情感」：时间线词 ≥2 且不含他/她/我们时（「情感过去未来」），
# 情感组得分落后 → best=羽时三刻 → 这里升级判定失效，关系问题被当成纯时间线问题。
RELATION_WORDS = tuple(KEYWORD_MAP[0][0]) + ("他", "她", "我们", "喜欢我吗", "还爱")
