...
See [CHANGELOG.md](CHANGELOG.md) for the full version history. Latest (v0.4.6): randomized shuffle hint pool; v0.4.5: strip spread names from AI prompt; @all detection compatible with both At(qq="all") and AtAll.
